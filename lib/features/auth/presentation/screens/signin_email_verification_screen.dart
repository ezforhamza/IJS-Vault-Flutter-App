...
/// Signin Email Verification Screen
/// Used when user logs in but email is not verified
/// Navigates to Home screen after successful verification (user already has tokens)
class SigninEmailVerificationScreen extends StatefulWidget {
  const SigninEmailVerificationScreen({super.key, required this.email});

  final String email;

  @override
  State<SigninEmailVerificationScreen> createState() =>
      _SigninEmailVerificationScreenState();
}

class _SigninEmailVerificationScreenState
    extends State<SigninEmailVerificationScreen> {
  ...
  Future<void> _verifyEmail() async {
    ...
    try {
      ...
      if (res.success) {
        ...
        // Navigate to Home (user is already logged in with tokens)
