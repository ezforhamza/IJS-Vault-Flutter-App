...
class SharedFilterSheet extends StatefulWidget {
  const SharedFilterSheet({super.key});

  @override
  State<SharedFilterSheet> createState() => _SharedFilterSheetState();
}

class _SharedFilterSheetState extends State<SharedFilterSheet> {
  final SharedVaultController controller = Get.find<SharedVaultController>();
